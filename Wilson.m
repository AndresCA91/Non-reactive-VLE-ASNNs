...
betaalphas  = -1.3676;                  % Scaling factor
betaW       = [0;0.8184;0.0393;0];      % Binary interaction parameters (Constant)
...
L2          = (MB*L1);                                                  % Eq. (15)
L3          = 1./(I1*L2);                                               % Eq. (16)
L4          = (I1*L3)-IV1;                                              % Eq. (17) - linear transfer function
L5          = (I1*L3);                                                  % Eq. (18)
L6          = (-MC*LW) + (MA*L2);                                       % Eq. (19)
L8          = (MA*x).*(MA*L3).*(MA*L5).*(I2*L6);                        % Eq. (25)
